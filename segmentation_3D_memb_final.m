...
%===================================================================%
ilastik_filename_MEMB = '1)E12_ecad_highmag_Probabilities.h5'; % ilastik prediction map here
%===================================================================%
...
%===================================================================%
imagename_MEMB = '1)E12_ecad_highmag.lif_1b_tbud.tif';   % membrane file name
%===================================================================%
...
title('seg1 MEMB (membrane ch), ilastik prediction map th >0.7')    
...
% seg1:                                             
%===================================================================%
seg1_MEMB = bwareaopen(seg1_MEMB,100);                               
seg1_MEMB = seg1_MEMB-bwareaopen(seg1_MEMB,15000);      
%===================================================================%
figure                                                              
imshow(sum(single(seg1_MEMB),3),[]);                                
title('z-projection of size th prediction map seg1 MEMB, pixel values > 0.7')           
%% seg4:                                  
%===================================================================%
seg2_MEMB = bwareaopen(seg2_MEMB,100);                               
seg2_MEMB = seg2_MEMB-bwareaopen(seg2_MEMB,15000);      
%===================================================================%
figure                                                              
imshow(sum(single(seg2_MEMB),3),[]);                                
...
seg3_MEMB = seg3_MEMB-bwareaopen(seg3_MEMB,15000);   
%===================================================================%
figure                                                              
imshow(sum(single(seg3_MEMB),3),[]);                                
...
seg4_MEMB = seg4_MEMB - bwareaopen(seg4_MEMB,15000);   
%===================================================================%
figure                                                              
imshow(sum(single(seg4_MEMB),3),[]);                                
...
name = 'Stacks_heatm1thru3_branches131-22-113.tif';
%===================================================================%
